...
@Named(value = "manhattanMB")
@ManagedBean
public class ManhattanView implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8290406143978661972L;
	...
	public static List<RankingValores> temp = Min_Max_ObjetivosBC.preencheVariaveis("manhattan",0.0);
